        ...
        if (encryptionToken != null && encrParts.size() > 0) {
            ...
            if (encryptionToken.isDerivedKeys()) {
                ...
                try {
                    ...
                    encr.getParts().addAll(encrParts);
                    ...
                    encr.prepare(RampartUtil.getEncryptionCrypto(config, rmd.getCustomClassLoader()));
...
//                                                    refList);
    ...
    private void doEncryptionWithSupportingToken(RampartPolicyData rpd, RampartMessageData rmd,
        ...
        try {
            ...
            encr.setSymmetricEncAlgorithm(rpd.getAlgorithmSuite().getEncryption());
            encr.setKeyEncAlgo(rpd.getAlgorithmSuite().getAsymmetricKeyWrap());
            encr.prepare(RampartUtil.getEncryptionCrypto(rpd.getRampartConfig(), rmd
